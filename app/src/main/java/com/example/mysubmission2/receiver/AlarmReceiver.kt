package com.example.mysubmission2.receiver
...
class AlarmReceiver : BroadcastReceiver() {
    ...
    private fun sendNotification(context: Context) {
        val intent = context.packageManager.getLaunchIntentForPackage("com.example.mysubmission2")
        val pendingIntent = PendingIntent.getActivity(context, 0, intent, 0)
        val notificationManager = context.getSystemService(Context.NOTIFICATION_SERVICE) as NotificationManager
        val builder = NotificationCompat.Builder(context, CHANNEL_ID)
            .setContentIntent(pendingIntent)
            .setSmallIcon(R.drawable.ic_baseline_notifications_24)
            .setContentTitle(context.resources.getString(R.string.github_notif))
            .setContentText(context.resources.getString(R.string.github_look))
            .setAutoCancel(true)
